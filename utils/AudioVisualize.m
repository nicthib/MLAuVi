function varargout = AudioVisualize(varargin)
gui_Singleton = 1;
gui_State = struct('gui_Name', mfilename, ...
    'gui_Singleton',  gui_Singleton, ...
    'gui_OpeningFcn', @AudioVisualize_OpeningFcn, ...
    'gui_OutputFcn',  @AudioVisualize_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
function AudioVisualize_OpeningFcn(hO, ~, h, varargin)
...
function varargout = AudioVisualize_OutputFcn(hO, ~, h)
...
function addoct_Callback(hObject, eventdata, handles)
function addoct_CreateFcn(hObject, eventdata, handles)
function ve_str_CreateFcn(hObject, eventdata, handles)
function vs_str_CreateFcn(hObject, eventdata, handles)
